...
import com.ece1778.keiming.assignment3.UI.CameraPreview;
...
public class CameraHandler {
    ...
    private Camera.PictureCallback mPicture = new Camera.PictureCallback() {
        ...
        public void onPictureTaken(byte[] data, Camera camera) {
            ...
            File pictureFile = FileUtils.getOutputMediaFile(FileColumns.MEDIA_TYPE_IMAGE);
            if (pictureFile == null){
    ...
    public CameraHandler(Context context, int id) {
        mContext = context;
